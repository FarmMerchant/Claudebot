/*
 * Vendored from https://github.com/supertone-inc/supertonic (nodejs/helper.js).
 * Copyright (c) 2025 Supertone Inc. MIT licensed — see SUPERTONIC-LICENSE.
 *
 * Unmodified. Kept here because Supertonic ships no usable npm package: the
 * published `supertonic` package is a 627-byte placeholder.
 */
import fs from 'fs';
